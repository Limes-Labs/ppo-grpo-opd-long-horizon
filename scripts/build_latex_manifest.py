...
def build_manifest(repo: Path, output_pdf: Path, min_pages: int) -> dict[str, Any]:
    inputs = [
        ...
        Path("paper/generated/sequence_policy_table.tex"),
        Path("paper/generated/credit_phase_table.tex"),
        Path("paper/generated/policy_gradient_table.tex"),
        Path("paper/generated/policy_implied_table.tex"),
        Path("paper/generated/policy_baseline_table.tex"),
        Path("paper/generated/selection_regret_table.tex"),
    ...
    return {
        ...
        "checks": {
            ...
            "sequence_policy_source": "results/sequence_policy_training_seedset.json",
            ...
            "selection_regret_source": "results/selection_regret_seedset.json",
        },
    }
